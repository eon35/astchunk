...
pip install tree-sitter-python tree-sitter-java tree-sitter-c-sharp tree-sitter-typescript tree-sitter-cpp
```
...
configs = {
    ...
    "language": "python",              # Supported: python, java, csharp, typescript, cpp
